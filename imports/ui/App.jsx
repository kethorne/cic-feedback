...
class App extends Component {
  ...
  editFeedback = feedbackID => {
    const updatedFeedback = window.prompt("What would you like your feedback to be updated to?");

   Meteor.call("feedback.update", feedbackID, updatedFeedback);
  };

  deleteFeedback = feedbackID => {
    const confirmDelete= window.confirm("Are you sure you want to delete your feedback?");
  ...
  filterStudents = event => {
    ...
    const filterResults = this.props.feedback.filter(feedback => {
